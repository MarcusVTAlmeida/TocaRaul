...
const App = ({navigation}) => {    
  const renderItem = ({ item }) => (
    ...
    <TouchableOpacity  onPress={() => {navigation.navigate('musicas', {musicas: item.musicas, imagem: item.imagem, album: item.album})}} style={{flexDirection:'row', alignItems:'center'}}>
